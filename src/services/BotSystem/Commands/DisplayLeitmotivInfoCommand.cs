...
namespace BotSystem
{
    ...
    {
        public static async Task ExecuteDisplayLeitmotivInfoCommand(SocketCommandContext context)
        {
            await context.Channel.SendMessageAsync("Le module est fondé autour de trois principes : \n\n" +
            ...
            await context.Channel.SendMessageAsync("Une bonne partie des animations seront à l'initiative des projets personnels des personnages qui souhaiteront modifier le monde dans lequel ils évoluent.\n\n");
        }
    }
}
