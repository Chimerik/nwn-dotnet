...
namespace NWN.Systems
{
  ...
  {
    public static bool ComputeCreatureSavingThrowDisadvantage(NwCreature creature, Ability ability, SpellEntry spellEntry = null, SpellEffectType effectType = SpellEffectType.Invalid, NwGameObject oCaster = null)
    {
