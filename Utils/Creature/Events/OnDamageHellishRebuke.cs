...
namespace NWN.Systems
{
  public static partial class CreatureUtils
  {
    public static async void OnDamageHellishRebuke(CreatureEvents.OnDamaged onDamage)
    {
      ...
      SpellUtils.DealSpellDamage(damager, onDamage.Creature.CasterLevel, spellEntry, SpellUtils.GetSpellDamageDiceNumber(onDamage.Creature, spell), onDamage.Creature, spell.GetSpellLevelForClass((ClassType)CustomClass.Warlock));
