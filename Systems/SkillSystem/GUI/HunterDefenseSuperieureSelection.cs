...
namespace NWN.Systems
{
  public partial class PlayerSystem
  {
    ...
    {
      public class HunterDefenseSuperieureSelectionWindow : PlayerWindow
      {
        ...
        public HunterDefenseSuperieureSelectionWindow(Player player) : base(player)
        {
          windowId = "hunterDefenseSuperieureSelection";
        ...
        {
          player.oid.LoginCreature.GetObjectVariable<PersistentVariableInt>("_IN_HUNTER_DEFENSE_SUPERIEURE_SELECTION").Value = 1;
          ...
          window = new NuiWindow(rootColumn, "Choisissez une défense supérieure")
          {
            Geometry = geometry,
            Resizable = false,
            Collapsed = false,
          ...
          if (player.oid.TryCreateNuiWindow(window, out NuiWindowToken tempToken, windowId))
          {
            ...
            selectedItemDescription.SetBindValue(player.oid, nuiToken.Token, "Sélectionner une défense supérieure\n\nAttention, le choix est définitif.");
            ...
            currentList = learnableDictionary.Values.Where(s => s is LearnableSkill ls && ls.category == Category.HunterDefenseSuperieure).OrderBy(s => s.name);
            ...
            case NuiEventType.Click:
              ...
              switch(nuiEvent.ElementId)
              {
                ...
                case "validate":
                  ...
                  player.oid.LoginCreature.GetObjectVariable<PersistentVariableInt>("_IN_HUNTER_DEFENSE_SUPERIEURE_SELECTION").Delete();
                  ...
                  player.oid.SendServerMessage($"Vous avez choisi la défense supérieure : {StringUtils.ToWhitecolor(selectedLearnable.name)} !", ColorConstants.Orange);
