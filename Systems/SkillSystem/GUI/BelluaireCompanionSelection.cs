...
namespace NWN.Systems
{
  public partial class PlayerSystem
  {
    ...
    {
      public class BelluaireCompanionSelectionWindow : PlayerWindow
      {
        ...
        public BelluaireCompanionSelectionWindow(Player player) : base(player)
        {
          windowId = "belluaireCompanionSelection";
        ...
        {
          player.oid.LoginCreature.GetObjectVariable<PersistentVariableInt>("_IN_BELLUAIRE_COMPANION_SELECTION").Value = 1;
          ...
          window = new NuiWindow(rootColumn, "Choisissez un compagnon")
          {
            Geometry = geometry,
            Resizable = false,
            Collapsed = false,
          ...
          if (player.oid.TryCreateNuiWindow(window, out NuiWindowToken tempToken, windowId))
          {
            ...
            selectedItemDescription.SetBindValue(player.oid, nuiToken.Token, "Sélectionner un compagnon\n\nAttention, le choix est définitif.");
            ...
            currentList = learnableDictionary.Values.Where(s => s is LearnableSkill ls && ls.category == Category.BelluaireCompanion).OrderBy(s => s.name);
            ...
            case NuiEventType.Click:
              ...
              switch(nuiEvent.ElementId)
              {
                ...
                case "validate":
                  ...
                  player.oid.LoginCreature.GetObjectVariable<PersistentVariableInt>("_IN_BELLUAIRE_COMPANION_SELECTION").Delete();
                  ...
                  player.oid.SendServerMessage($"Vous avez choisi le compagnon : {StringUtils.ToWhitecolor(selectedLearnable.name)} !", ColorConstants.Orange);
