...
namespace NWN.Systems
{
  public partial class PlayerSystem
  {
    ...
    {
      public class EnsoDracoAffiniteElementaireSelectionWindow : PlayerWindow
      {
        ...
        public EnsoDracoAffiniteElementaireSelectionWindow(Player player) : base(player)
        {
          windowId = "ensoDracoAffiniteElementaireSelection";
        ...
        public void CreateWindow()
        {
          ...
          window = new NuiWindow(rootColumn, "Choisissez votre affinité élémentaire")
          {
            Geometry = geometry,
            Resizable = false,
            Collapsed = false,
          ...
          if (player.oid.TryCreateNuiWindow(window, out NuiWindowToken tempToken, windowId))
          {
            ...
            selectedItemDescription.SetBindValue(player.oid, nuiToken.Token, "Sélectionner une affinité élémentaire afin d'afficher ses détails.\n\nAttention, le choix est définitif.");
            ...
            currentList = learnableDictionary.Values.Where(s => s is LearnableSkill ls && ls.category == Category.AffiniteElementaire
            ...
            if (!currentList.Any())
            {
              ...
              player.oid.SendServerMessage("Vous connaissez déjà toutes les affinités élémentaires", ColorConstants.Orange);
              return;
            }
