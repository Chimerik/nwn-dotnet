...
namespace NWN.Systems
{
  public partial class PlayerSystem
  {
    ...
    {
      public class HunterTactiqueDefensiveSelectionWindow : PlayerWindow
      {
        ...
        public HunterTactiqueDefensiveSelectionWindow(Player player) : base(player)
        {
          windowId = "hunterTactiqueDefensiveSelection";
        ...
        {
          player.oid.LoginCreature.GetObjectVariable<PersistentVariableInt>("_IN_HUNTER_TACTIQUE_DEFENSIVE_SELECTION").Value = 1;
          ...
          window = new NuiWindow(rootColumn, "Choisissez une tactique défensive")
          {
            Geometry = geometry,
            Resizable = false,
            Collapsed = false,
          ...
          if (player.oid.TryCreateNuiWindow(window, out NuiWindowToken tempToken, windowId))
          {
            ...
            selectedItemDescription.SetBindValue(player.oid, nuiToken.Token, "Sélectionner une tactique défensive\n\nAttention, le choix est définitif.");
            ...
            currentList = learnableDictionary.Values.Where(s => s is LearnableSkill ls && ls.category == Category.HunterTactiqueDefensive).OrderBy(s => s.name);
            ...
            case NuiEventType.Click:
              ...
              switch(nuiEvent.ElementId)
              {
                ...
                case "validate":
                  ...
                  player.oid.LoginCreature.GetObjectVariable<PersistentVariableInt>("_IN_HUNTER_TACTIQUE_DEFENSIVE_SELECTION").Delete();
                  ...
                  player.oid.SendServerMessage($"Vous avez choisi la tactique défensive : {StringUtils.ToWhitecolor(selectedLearnable.name)} !", ColorConstants.Orange);
