...
namespace NWN.Systems
{
  public static partial class SkillSystem
  {
    ...
    public static Feat[] languageSkillBooks = new Feat[] { Feat.Abyssal, Feat.Céleste, Feat.Gnome, Feat.Draconique, Feat.Druidique, Feat.Nain, Feat.Elfique, Feat.Géant, Feat.Gobelin, Feat.Halfelin, Feat.Infernal, Feat.Orc, Feat.Primordial, Feat.Sylvain, Feat.Voleur, Feat.Gnome };
