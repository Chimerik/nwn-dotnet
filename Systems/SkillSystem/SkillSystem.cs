...
namespace NWN.Systems
{
  public static class SkillSystem
  {
    ...
    public static Dictionary<Feat, CustomFeat> customFeatsDictionnary = new Dictionary<Feat, CustomFeat>()
    {
      ...
      { CustomFeats.Forge, new CustomFeat("Forge", "Diminue le temps de fabrication, de réparation, de réparation et le coût en matériaux d'un objet de la forge de 1 % par niveau.", 10) },
      { CustomFeats.CraftClothing, new CustomFeat("Craft Vêtements", "Diminue le temps de fabrication, de réparation, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftFullPlate, new CustomFeat("Craft Harnois", "Diminue le temps de fabrication, de réparation, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftHalfPlate, new CustomFeat("Craft Armure de Plaques", "Diminue le temps de fabrication, de réparation, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftSplintMail, new CustomFeat("Craft Clibanion", "Diminue le temps de fabrication, de réparation, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftBreastPlate, new CustomFeat("Craft Cuirasse", "Diminue le temps de fabrication, de réparation, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftScaleMail, new CustomFeat("Craft Chemise de mailles", "Diminue le temps de fabrication, de réparation, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftStuddedLeather, new CustomFeat("Craft Cuir clouté", "Diminue le temps de fabrication, de réparation, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftLeatherArmor, new CustomFeat("Craft Armure de cuir", "Diminue le temps de fabrication, de réparation, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftPaddedArmor, new CustomFeat("Craft Armure matelassée", "Diminue le temps de fabrication, de réparation, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftShortsword, new CustomFeat("Craft Epée courte", "Diminue le temps de fabrication, de réparation, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftLongsword, new CustomFeat("Craft Epée longue", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftBattleAxe, new CustomFeat("Craft Hache d'armes", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftBastardSword, new CustomFeat("Craft Epée bâtarde", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftLightFlail, new CustomFeat("Craft Fléau léger", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftWarHammer, new CustomFeat("Craft Marteau de guerre", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftHeavyCrossbow, new CustomFeat("Craft Arbalète lourde", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftLightCrossbow, new CustomFeat("Craft Arbalète légère", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftLongBow, new CustomFeat("Craft Arc long", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftLightMace, new CustomFeat("Craft Masse légère", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftHalberd, new CustomFeat("Craft Hallebarde", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftShortBow, new CustomFeat("Craft Arc court", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftTwoBladedSword, new CustomFeat("Craft Double lame", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftGreatSword, new CustomFeat("Craft Epée à deux mains", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftSmallShield, new CustomFeat("Craft Rondache", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftTorch, new CustomFeat("Craft Torche", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftHelmet, new CustomFeat("Craft Heaume", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftGreatAxe, new CustomFeat("Craft Grande Hache", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftAmulet, new CustomFeat("Craft Amulette", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftArrow, new CustomFeat("Craft Flèche", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftBelt, new CustomFeat("Craft Ceinture", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftDagger, new CustomFeat("Craft Dague", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftBolt, new CustomFeat("Craft Carreau", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftBoots, new CustomFeat("Craft Bottes", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftBullets, new CustomFeat("Craft Billes", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftClub, new CustomFeat("Craft Gourdin", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftDarts, new CustomFeat("Craft Dards", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftDireMace, new CustomFeat("Craft Masse double", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftHeavyFlail, new CustomFeat("Craft Fléau lourd", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftGloves, new CustomFeat("Craft Gants", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftLightHammer, new CustomFeat("Craft Marteau léger", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftHandAxe, new CustomFeat("Craft Hachette", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftKama, new CustomFeat("Craft Kama", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftKukri, new CustomFeat("Craft Kukri", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftMagicRod, new CustomFeat("Craft Baguette", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftStaff, new CustomFeat("Craft Bourdon", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftMagicWand, new CustomFeat("Craft Baguette", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftMorningStar, new CustomFeat("Craft Morgenstern", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftPotion, new CustomFeat("Craft Potion", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftQuarterstaff, new CustomFeat("Craft Bâton", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftRapier, new CustomFeat("Craft Rapière", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftRing, new CustomFeat("Craft Anneau", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftScimitar, new CustomFeat("Craft Cimeterre", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftScythe, new CustomFeat("Craft Faux", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftLargeShield, new CustomFeat("Craft Ecu", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftTowerShield, new CustomFeat("Craft Pavois", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftShortSpear, new CustomFeat("Craft Lance", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftShuriken, new CustomFeat("Craft Shuriken", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftSickle, new CustomFeat("Craft Serpe", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftSling, new CustomFeat("Craft Fronde", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftThrowingAxe, new CustomFeat("Craft Hache de jet", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftSpellScroll, new CustomFeat("Craft Parchemin", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftBracer, new CustomFeat("Craft Brassard", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftCloak, new CustomFeat("Craft Cape", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftTrident, new CustomFeat("Craft Trident", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftDwarvenWarAxe, new CustomFeat("Craft Hache naine", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftWhip, new CustomFeat("Craft Fouet", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftDoubleAxe, new CustomFeat("Craft Double Hache", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftForgeHammer, new CustomFeat("Craft Marteau d'artisan", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftKatana, new CustomFeat("Craft Katana", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
      { CustomFeats.CraftOreExtractor, new CustomFeat("Craft Extracteur de ressources", "Diminue le temps de fabrication, de réparation et le coût en matériaux de l'objet concerné de 1 % par niveau.", 10) },
    ...
    public static int[] forgeBasicSkillBooks = new int[] { CustomSkill.MineralExtraction, CustomSkill.MineralExtractionYield, CustomSkill.ReprocessingOre, CustomSkill.ReprocessingOreEfficiency, CustomSkill.ReprocessingGrade1Expertise, CustomSkill.ReprocessingGrade2Expertise, CustomSkill.MateriaGradeConcentration, CustomSkill.BlueprintCopy, CustomSkill.BlueprintEfficiency, CustomSkill.BlueprintEconomy, CustomSkill.BlueprintMetallurgy, CustomSkill.BlueprintResearch };
