...
namespace NWN.Systems
{
  public static class SkillSystem
  {
    ...
    public static void InitializeLearnables()
    {
      ...
      learnableDictionary.Add(CustomSkill.SurchargeArcanique, new LearnableSkill(CustomSkill.SurchargeArcanique, "Surcharge arcanique", "Permet de forcer l'ajout d'emplacements d'inscriptions sur un objet au risque de le briser.\n\nAugmente de 1 % par niveau la chance de parvenir à forcer l'ajout d'un emplacement d'enchantement supplémentaire.", Category.Craft, "ife_X2EpicRepu", 10, 2, Ability.Charisma, Ability.Constitution));
      ...
      //learnableDictionary.Add(CustomSkill.EnchanteurExpert, new LearnableSkill(CustomSkill.EnchanteurExpert, "Enchanteur Expert", "Augmente de 2 % par niveau la chance d'incanter une plus puissant.", Category.Craft, "ife_X2EpicRepu", 10, 2, Ability.Charisma, Ability.Intelligence));
      learnableDictionary.Add(CustomSkill.EnchanteurChanceux, new LearnableSkill(CustomSkill.EnchanteurChanceux, "Enchanteur Chanceux", "Augmente de 1 % par niveau la chance de ne pas consommer d'emplacement lors d'une inscription.", Category.Craft, "ife_X2EpicRepu", 10, 3, Ability.Charisma, Ability.Intelligence));
