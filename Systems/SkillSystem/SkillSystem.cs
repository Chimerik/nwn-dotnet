...
namespace NWN.Systems
{
  public static class SkillSystem
  {
    ...
    {
      { CustomSkill.ImprovedStrength, new LearnableSkill(CustomSkill.ImprovedStrength, "Force accrue", "Augmente la force d'un point par niveau d'entraînement.", Category.MindBody, "ife_X2GrStr1", 4, 3, Ability.Constitution, Ability.Strength) },
      { CustomSkill.ImprovedDexterity, new LearnableSkill(CustomSkill.ImprovedDexterity, "Dextérité accrue", "Augmente la dextérité d'un point par niveau d'entraînement.", Category.MindBody, "ife_X2GrDex1", 4, 3, Ability.Constitution, Ability.Dexterity) },
      { CustomSkill.ImprovedConstitution, new LearnableSkill(CustomSkill.ImprovedConstitution, "Constitution accrue", "Augmente la constitution d'un point par niveau d'entraînement.", Category.MindBody, "ife_X2GrCon1", 4, 3, Ability.Constitution, Ability.Charisma) },
      { CustomSkill.ImprovedIntelligence, new LearnableSkill(CustomSkill.ImprovedIntelligence, "Intelligence accrue", "Augmente l'intelligence d'un point par niveau d'entraînement.", Category.MindBody, "ife_X2GrInt1", 4, 3, Ability.Constitution, Ability.Intelligence) },
      { CustomSkill.ImprovedWisdom, new LearnableSkill(CustomSkill.ImprovedWisdom, "Sagesse accrue", "Augmente la sagesse d'un point par niveau d'entraînement.", Category.MindBody, "ife_X2GrWis1", 4, 3, Ability.Constitution, Ability.Wisdom) },
      { CustomSkill.ImprovedCharisma, new LearnableSkill(CustomSkill.ImprovedCharisma, "Charisme accrue", "Augmente le charisme d'un point par niveau d'entraînement.", Category.MindBody, "ife_X2GrCha1", 4, 3, Ability.Constitution, Ability.Charisma) },
      { CustomSkill.ImprovedHealth, new LearnableSkill(CustomSkill.ImprovedHealth, "Résilience", "Augmente les points de vie de de 1 + (Robustesse + 3 * modificateur de constitution de base) par niveau.\n\n Ce don est rétroactif.", Category.MindBody, "ife_X2GrCon1", 5, 2, Ability.Constitution, Ability.Charisma) },
      { CustomSkill.Toughness, new LearnableSkill(CustomSkill.Toughness, "Robustesse", "Augmente le multiplicateur d'augmentation des points de vie de un par niveau d'entraînement.\n\n Rétroactif.", Category.MindBody, "ife_tough", 5, 1, Ability.Constitution, Ability.Charisma) },
      { CustomSkill.Acolyte, new LearnableSkill(CustomSkill.Acolyte, "Acolyte", "Vous avez passé votre vie au service d'un temple et d'un dieu ou d'un panthéon.\nVous agissez en qualité d'intermédiaire entre le divin et le monde mortel, performant rites sacrés et offrandes sacrificielles afin d'amener les adeptes en présence du divin.\nVous n'êtes pas forcément un prêtre, organiser des rites sacrés et canaliser la puissance divine n'étant pas la même chose.\n\nChoisissez un dieu, un panthéon ou autre être quasi-divin et déterminez avec votre DM les détails de la nature de votre service religieux.\nEtiez-vous simple fonctionnaire dans un temple, élevé depuis l'enfance à assister les prêtres dans leurs rites sacrés ?\nOu bien un prêtre ordonné ayant soudain reçu l'appel du service vers une nouvelle voie ?\nPeut-être dirigiez-vous un petit culte en dehors de toute structure cléricale, ou encore un group occulte au service d'un maître démoniaque que vous rejetez aujourd'hui ?\n\nCompétences supplémentaires : Intuition, Religion, une langue.\nIdée d'objet rp de départ : un symbole sacré, un livre de prière, une bure (à voir avec votre dm pour éventuelle création technique).\n\nAide à la création de personnage :\n\nL'expérience en temple ou autre communauté religieuse fait partie intégrante de l'état d'esprit d'un acolyte.\nLeurs études de l'histoires des tenant de leur foi et leurs relations aux temples, autels et hiérarchies cléricales influence leurs manières et idéaux.\nLeurs faiblesses peuvent être une hypocrisie dissimulée, une idée hérétique ou encore un idéal ou voeu exagéré et extrême.\n\n(d8) Trait de personnalité :\n\n1 : J'idolâtre un héros de ma foi et me réfère constamment à ses exploits.\n2 : Je suis capable d'aider les plus féroces ennemis à trouver un terrain d'entente à force d'empathie afin de les aider à travailler vers la paix.\n3 : Chaque événement est pour mois un présage. Les dieux essaient toujours de nous parler, il nous faut seulement écouter.\n4 : Rien ne peut ébranler mon attitude optimiste.\n5 : Je cite (ou déforme) les textes et proverbes sacrés dans presque toutes les situations.\n6 : Je suis tolérant (ou intolérant) des autres fois et respecte (ou condamne) la vénération d'autres déités.\n7 : J'étais habitué aux bons mets et aux bons vins parmi l'élite de mon temple. La vie à la dure, ce n'est pas pour moi.\n8 : J'ai passé tellement de temps au temple que j'ai presque aucune expérience pratique des gens du monde extérieur.\n\n(d6) Idéal :\n\n1 : Tradition. Les anciennes traditions d'adoration et de sacrifice doivent être maintenues et préservées.\n2 : Charité. J'essaie toujours d'aider les nécessiteux, quoi qu'il m'en coûte.\n3 : Changement. Nous devons aider à concrétiser les changements auquels les dieux travaillent incessammentde par le monde.\n4 : Pouvoir. J'ai pour ambition de m'élever, un jour, au sommet de la hiérarchie de ma foi.\n5 : Piété. J'ai confiance en ma déité pour guider mes actes. Si je suis ses préceptes, toute chose ira pour le mieux.\n6 : Aspirations. Je cherche à me prouver digne de la faveur de ma déité en en conformant mes chacun de mes actes à ses préceptes.\n\n(d6) Lien : \n\n1 : Je suis prêt à mourir pour retrouver une ancienne relique de ma foi, perdue il y a des éons.\n2 : Un jour, j'aurai ma revanche contre la hiérarchie du temple qui m'a imposé la marque de l'hérésie.\n3 : Je dois ma vie au prêtre qui s'est occupé de moi après la mort de mes parents.\n4 : Tout ce que je fais est pour aider le petit peuple.\n5 : Je ferai tout pour protéger le temple où j'ai servi.\n6 : Je cherche à préserver un texte sacré que que mes ennemis considèrent comme hérétiques et cherchent à détruire.\n\nFaiblesse :\n\n1 : Je juge les autres avec sévérité. Et moi-même plus durement encore.\n2 : J'ai trop confiance en ceux qui ont le pouvoir au sein de la hiérarchie de mon temple.\n3 : Ma piété m'amène parfois à croire aveuglément ceux qui se réclament de ma foi.\n4 : Ma façon de penser est rigide et inflexible.\n5 : Je suis très suspicieux des étrangers et m'attend au pire de leur part.\n6 : Lorsque je me choisis un but, il devient mon obsession au détriment de tout le reste dans ma vie.", Category.StartingTraits, "ife_X2GrWis1", 1, 1, Ability.Wisdom, Ability.Charisma) },
    };
