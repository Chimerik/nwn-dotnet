...
namespace NWN.Systems
{
  public static partial class SkillSystem
  {
    ...
    public static Feat[] forgeBasicSkillBooks = new Feat[] { Feat.Metallurgy, Feat.Miner, Feat.Prospection, Feat.StripMiner, Feat.Reprocessing, Feat.Forge, Feat.CraftDireMace };
