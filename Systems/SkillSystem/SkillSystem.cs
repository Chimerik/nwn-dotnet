...
namespace NWN.Systems
{
  public static partial class SkillSystem
  {
    ...
    public static void InitializeLearnables()
    {
      ...
      learnableDictionary.Add(CustomSkill.AcidSplash, new LearnableSkill(CustomSkill.AcidSplash, "Aspersion d'acide", "", Category.Magic, NwSpell.FromSpellType(Spell.AcidSplash).Description.ToString(), 1, 1, Ability.Intelligence, Ability.Charisma, LearnActivableFeat, "1M6p0_VHfGmN10U2afrwEbERUG0ipWnVRg2WmDbO9CJw"));
      learnableDictionary.Add(CustomSkill.ElectricJolt, new LearnableSkill(CustomSkill.ElectricJolt, "Poigne électrique", "", Category.Magic, NwSpell.FromSpellType(Spell.ElectricJolt).Description.ToString(), 1, 1, Ability.Intelligence, Ability.Charisma, LearnActivableFeat, "1U3BR1CigyfI0tHgZRYFCYp1CMqpcJQKkIk2Z5iMcpjY"));
      learnableDictionary.Add(CustomSkill.BladeWard, new LearnableSkill(CustomSkill.BladeWard, "Protection contre les lames", "", Category.Magic, NwSpell.FromSpellId(CustomSpell.BladeWard).Description.ToString(), 1, 1, Ability.Intelligence, Ability.Charisma, LearnActivableFeat, "1T4Eq-3vbgcYalcmsRd3Z0695V8mtl6gkQkZO32kExrE"));
      learnableDictionary.Add(CustomSkill.FireBolt, new LearnableSkill(CustomSkill.FireBolt, "Trait de feu", "", Category.Magic, NwSpell.FromSpellId(CustomSpell.FireBolt).Description.ToString(), 1, 1, Ability.Intelligence, Ability.Charisma, LearnActivableFeat, "1-_kTzoprOBn7y40Hjd4UVhAoDmj14zmF1_ecOUWL13g"));
      learnableDictionary.Add(CustomSkill.Friends, new LearnableSkill(CustomSkill.Friends, "Amis", "", Category.Magic, NwSpell.FromSpellId(CustomSpell.Friends).Description.ToString(), 1, 1, Ability.Intelligence, Ability.Charisma, LearnActivableFeat, "1Tt0suEi0JpiyUubumdIvSa1pct9RYPB-gfkfxzCVPiQ"));
      learnableDictionary.Add(CustomSkill.BoneChill, new LearnableSkill(CustomSkill.BoneChill, "Frisson Glacial", "", Category.Magic, NwSpell.FromSpellId(CustomSpell.BoneChill).Description.ToString(), 1, 1, Ability.Intelligence, Ability.Charisma, LearnActivableFeat, "16r6h5lIlkNqBNzCqbx8jhRiUgpauuZZCtT_qWI1GEnM"));
      learnableDictionary.Add(CustomSkill.TrueStrike, new LearnableSkill(CustomSkill.TrueStrike, "Coup au but", "", Category.Magic, NwSpell.FromSpellType(Spell.TrueStrike).Description.ToString(), 1, 1, Ability.Intelligence, Ability.Charisma, LearnActivableFeat, "1TZJaffIhTNFAv1PDt36gsUyHi6TM4tI9o94O231zmF4"));
      learnableDictionary.Add(CustomSkill.PoisonSpray, new LearnableSkill(CustomSkill.PoisonSpray, "Bouffée empoisonnée", "", Category.Magic, NwSpell.FromSpellId(CustomSpell.PoisonSpray).Description.ToString(), 1, 1, Ability.Intelligence, Ability.Charisma, LearnActivableFeat, "1bm9ARYJBgop2AZi3q4fAYLdtgoErVvnaNETbgPlZ3N8"));
      ...
      learnableDictionary.Add(CustomSkill.FaerieFireDrow, new LearnableSkill(CustomSkill.FaerieFireDrow, "Lueurs Féeriques (Drow)", "", Category.Magic, NwSpell.FromSpellId(CustomSpell.FaerieFire).Description.ToString(), 1, 1, Ability.Intelligence, Ability.Charisma, LearnActivableFeat, "1Ut8lMeDdxKlHcZbSwi3Lf4hR6e5xFA3ZM4grhg2fdZA"));
      ...
      learnableDictionary.Add(CustomSkill.EnlargeDuergar, new LearnableSkill(CustomSkill.EnlargeDuergar, "Agrandissement (Duergar)", "", Category.Magic, NwSpell.FromSpellId(CustomSpell.Enlarge).Description.ToString(), 1, 1, Ability.Intelligence, Ability.Charisma, LearnActivableFeat, "1tDes5H2Rj5S1wrW6ulSWKFaCrb6lnJudKmDlLW24LMw"));
      learnableDictionary.Add(CustomSkill.SpeakAnimalGnome, new LearnableSkill(CustomSkill.SpeakAnimalGnome, "Communication Animale (Gnome des forêts)", "", Category.Magic, NwSpell.FromSpellId(CustomSpell.SpeakAnimal).Description.ToString(), 1, 1, Ability.Intelligence, Ability.Charisma, LearnActivableFeat, "10DK57_XN_jdXO8go_vqYX6e23VGvUoRpAGVg5KTHGlU"));
