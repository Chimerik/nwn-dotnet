...
namespace NWN.Systems
{
  public static partial class SkillSystem
  {
    ...
    public static Dictionary<API.Constants.Feat, CustomFeat> customFeatsDictionnary = new Dictionary<API.Constants.Feat, CustomFeat>()
    {
      ...
      { CustomFeats.Magnat, new CustomFeat("Magnat", "Permet d'ouvrir une échoppe supplémentaire par niveau (enchères comprises).", 5) },
      ...
      { CustomFeats.SurchargeControlee, new CustomFeat("Surcharge Contrôlée", "Augmentede 2 % par niveau la chance de conserver l'objet intact lors de l'échec d'une tentative de surcharge.", 10) },
    ...
    public static Dictionary<Feat, Func<PlayerSystem.Player, Feat, int>> RegisterAddCustomFeatEffect = new Dictionary<Feat, Func<PlayerSystem.Player, Feat, int>>
    {
            ...
            { CustomFeats.ImprovedConstitution, HandleHealthPoints },
    };
    ...
    public static int GetCustomFeatLevelFromSkillPoints(API.Constants.Feat feat, int currentSkillPoints)
    {
      int multiplier = 1;
