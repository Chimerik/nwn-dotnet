...
namespace NWN.Systems
{
  public static class SkillSystem
  {
    ...
    public static Dictionary<int, Learnable> learnableDictionary = new Dictionary<int, Learnable>()
    {
      ...
      { CustomSkill.ImprovedConstitution, new LearnableSkill(CustomSkill.ImprovedConstitution, "Constitution accrue", "Augmente la constitution d'un point par niveau d'entraînement.", Category.MindBody, "ife_X2GrCon1", 4, 3, Ability.Constitution, Ability.Strength) },
