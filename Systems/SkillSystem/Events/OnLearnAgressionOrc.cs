...
namespace NWN.Systems
{
  ...
  {
    public static bool OnLearnAgressionOrc(PlayerSystem.Player player, int customSkillId)
    {
      if (!player.oid.LoginCreature.KnowsFeat((Feat)CustomSkill.AgressionOrc))
        player.oid.LoginCreature.AddFeat((Feat)CustomSkill.AgressionOrc);
