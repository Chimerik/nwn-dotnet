...
namespace NWN.Systems
{
  ...
  {
    public static bool OnLearnMaitreDHast(PlayerSystem.Player player, int customSkillId)
    {
      if (!player.oid.LoginCreature.KnowsFeat((Feat)CustomSkill.HastMaster))
        player.oid.LoginCreature.AddFeat((Feat)CustomSkill.HastMaster);
