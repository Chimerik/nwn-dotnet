...
namespace NWN.Systems
{
  public partial class PlayerSystem
  {
    ...
    {
      public class AspectTotemSelectionWindow : PlayerWindow
      {
        ...
        public AspectTotemSelectionWindow(Player player) : base(player)
        {
          windowId = "aspectTotemSelection";
        ...
        {
          player.oid.LoginCreature.GetObjectVariable<PersistentVariableInt>("_IN_ASPECT_TOTEM_SELECTION").Value = 1;
          ...
          window = new NuiWindow(rootColumn, "Choisissez un aspect animal")
          {
            Geometry = geometry,
            Resizable = false,
            Collapsed = false,
          ...
          if (player.oid.TryCreateNuiWindow(window, out NuiWindowToken tempToken, windowId))
          {
            ...
            selectedItemDescription.SetBindValue(player.oid, nuiToken.Token, "Sélectionner un aspect animal pour afficher ses détails.\n\nAttention, le choix est définitif.");
            ...
            currentList = learnableDictionary.Values.Where(s => s is LearnableSkill ls && ls.category == Category.AspectTotem);
            ...
            case NuiEventType.Click:
              ...
              switch(nuiEvent.ElementId)
              {
                case "select":
                  ...
                  validationText.SetBindValue(player.oid, nuiToken.Token, $"Valider l'esprit animal {selectedLearnable.name}");
