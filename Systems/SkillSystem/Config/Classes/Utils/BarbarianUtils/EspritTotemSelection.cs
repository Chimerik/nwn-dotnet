...
namespace NWN.Systems
{
  public partial class PlayerSystem
  {
    ...
    {
      public class EspritTotemSelectionWindow : PlayerWindow
      {
        ...
        public EspritTotemSelectionWindow(Player player) : base(player)
        {
          windowId = "espritTotemSelection";
        ...
        {
          player.oid.LoginCreature.GetObjectVariable<PersistentVariableInt>("_IN_ESPRIT_TOTEM_SELECTION").Value = 1;
          ...
          window = new NuiWindow(rootColumn, "Choisissez un esprit totem")
          {
            Geometry = geometry,
            Resizable = false,
            Collapsed = false,
          ...
          if (player.oid.TryCreateNuiWindow(window, out NuiWindowToken tempToken, windowId))
          {
            ...
            selectedItemDescription.SetBindValue(player.oid, nuiToken.Token, "Sélectionner un esprit totem pour afficher ses détails.\n\nAttention, le choix est définitif.");
            ...
            currentList = learnableDictionary.Values.Where(s => s is LearnableSkill ls && ls.category == Category.EspritTotem);
            ...
            case NuiEventType.Click:
              ...
              switch(nuiEvent.ElementId)
              {
                case "select":
                  ...
                  validationText.SetBindValue(player.oid, nuiToken.Token, $"Valider l'esprit totem {selectedLearnable.name}");
                ...
                case "validate":
                  ...
                  player.oid.LoginCreature.GetObjectVariable<PersistentVariableInt>("_IN_ESPRIT_TOTEM_SELECTION").Delete();
