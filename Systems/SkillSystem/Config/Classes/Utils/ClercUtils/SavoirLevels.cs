    ...
    public static void HandleSavoirLevelUp(Player player, int level)
    {
      switch (level)
      {
        case 1: 
          ...
          ClercUtils.LearnDomaineSpell(player, (int)Spell.Sleep);
        ...
        case 3:
          ...
          ClercUtils.LearnDomaineSpell(player, CustomSpell.Apaisement);
        ...
        case 5:
          ...
          ClercUtils.LearnDomaineSpell(player, (int)Spell.Slow);
        ...
        case 7:
          ...
          ClercUtils.LearnDomaineSpell(player, CustomSpell.SphereResilienteDotiluke);
        ...
        case 9:
          ...
          ClercUtils.LearnDomaineSpell(player, CustomSpell.Telekinesie);
