      ...
      foreach (var creature in targets)
      {
        ...
        switch (type)
        {
          ...
          case TrapBaseType.DeadlyAcidSplash:
            SpikeTrap(creature, trap, trapTable.GetRow((int)type)); return;
          case TrapBaseType.MinorAcid:
          case TrapBaseType.AverageAcid:
          case TrapBaseType.StrongAcid:
          case TrapBaseType.DeadlyAcid: AcidTrap(creature, trap, trapTable.GetRow((int)type)); return;
          ...
          case TrapBaseType.EpicFrost: FrostTrap(creature, trap, trapTable.GetRow((int)type)); return;
          case TrapBaseType.MinorNegative:
          case TrapBaseType.AverageNegative:
          case TrapBaseType.StrongNegative:
          case TrapBaseType.DeadlyNegative: NecroticTrap(creature, trap, trapTable.GetRow((int)type)); return;
