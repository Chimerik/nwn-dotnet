...
namespace NWN.Systems
{
  ...
  {
    public static async Task ExecuteDisplayMultiAccountInfoCommand(SocketCommandContext context)
    {
      await context.Channel.SendMessageAsync("Le multi-compte n'est pas autorisé : 1 un joueur = 1 personnage afin de permettre de se concentrer et de s'investir principalement sur le rp de ce personnage.\n\n" +
