  ...
  public static partial class BotSystem
  {
    public static string ExecuteDisplayRoleplaySpellsInfoCommand()
    {
      return "\n\n**Gestion des sorts rp :**\n\n" +
        ...
        "    * Vous seul serez alors le seul possesseur de ce sort. Libre à vous, cependant, d'en fabriquer des parchemins via l'artisanat afin de permettre à d'autres de l'apprendre à leur tour.\n\n";
    }
  }
}
