...
namespace NWN.Systems
{
  ...
  {
    public static string ExecuteDisplayUniverseInfoCommand(SocketCommandContext context)
    {
      context.Channel.SendMessageAsync("L'univers du module a une connexion forte avec les Royaumes Oubliés afin de permettre aux joueurs de disposer d'une base commune classique et bien connue sur laquelle établir leur background initial.\n\n" +
      ...
      return "Nos pjs sont donc ceux qui, d'une manière ou d'une autre, ont répondu à cet appel.\n";
    }
  }
}
