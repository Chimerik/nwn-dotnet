...
namespace NWN.Systems
{
  ...
  {
    public static string ExecuteDisplayAlignementInfoCommand(SocketCommandContext context)
    {
      context.Channel.SendMessageAsync("Sur les Larmes, l'alignement n'est pas une mesure ponctuelle de l'état d'esprit d'un personnage à l'instant T. Chaque action du personnage ne provoque pas un gain de points dans telle ou telle direction.\n" +
      ...
      context.Channel.SendMessageAsync("L'autre aspect qui pose généralement problème avec le système d'alignement est leur définition.\n\n" +
      ...
      context.Channel.SendMessageAsync("Voici un exemple de la vie courante qui permet d'illustrer ce type de nuances :\n\n" +
      ...
      context.Channel.SendMessageAsync("De la même façon, un personnage bon peut parfaitement avoir à recours à des actions 'mauvaises' à partir du moment où il considère que ces actions bénéficient à l'intérêt général.\n\n" +
      ...
      context.Channel.SendMessageAsync("Enfin, l'alignement gardé pour la fin :\n\n" +
