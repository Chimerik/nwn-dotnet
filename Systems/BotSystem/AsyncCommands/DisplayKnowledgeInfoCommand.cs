...
namespace NWN.Systems
{
  ...
  {
    public static async Task ExecuteDisplayKnowledgeInfoCommand(SocketCommandContext context)
    {
      await context.Channel.SendMessageAsync("**Savoir et connaissances rp :**\n\n" +
