...
namespace NWN.Systems
{
  ...
  {
    public static string ExecuteDisplayEvilInfoCommand(SocketCommandContext context)
    {
      context.Channel.SendMessageAsync("Le rp evil a le potentiel d'être un énorme moteur d'animation entre joueurs sur un module, permettant d'alléger nettement la charge qui pèse sur les dms en insérant des relations conflictuels entre joueurs qui alors n'ont même plus besoin d'être directement animés.\n\n" +
