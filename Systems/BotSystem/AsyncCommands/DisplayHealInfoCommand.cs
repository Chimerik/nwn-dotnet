...
namespace NWN.Systems
{
  ...
  {
    public static string ExecuteDisplayHealInfoCommand(SocketCommandContext context)
    {
      context.Channel.SendMessageAsync("Avant de parler des soins, il faut parler de l'interprétation des points de vie et des blessures.\n\n" +
