...
namespace NWN.Systems
{
  ...
  {
    public static string ExecuteDisplayPVPInfoCommand(SocketCommandContext context)
    {
      context.Channel.SendMessageAsync("Le PvP consiste en n'importe quelle action conflictuelle entreprise par un personnage joueur contre un autre personnage joueur. Cette action peut aussi bien être le techniquement très simple 'Clic droit, attaquer' qu'une tentative plus complexe de détruire quelque chose mis en place par le personnage ciblé (sa faction, sa maison, son commerce, etc) et nécessitant généralement une intervention ou validation du staff.\n\n" +
