...
namespace NWN.Systems
{
  ...
  {
    public static async Task ExecutePrepareAsyncSaveDescriptionCommand(SocketCommandContext context, string pcName, string descriptionName, string descriptionText)
    {
      ...
      ModuleSystem.module.botAsyncCommandList.Add($"description_{pcID}_{descriptionName}_{descriptionText}");
