...
namespace NWN.Systems
{
    public static partial class BotSystem
    {
        public static async Task ExecuteDisplayAlignementInfoCommand(SocketCommandContext context)
        {
            ...
            await context.Channel.SendMessageAsync("Ainsi donc, un personnage mauvais n'ira pas nécessairement nuire aux autres, juste 'parce qu'il le peut'. Il est tout à fait capable de s'insérer dans une société et d'y participer de façon constructive. En revanche, il se fera passer avant les autres quelles que soient les conséquences pour les autres.\n\n" +
              "De la même façon, un personnage bon peut parfaitement avoir à recours à des actions 'mauvaises' à partir du moment où il considère que ces actions bénéficient à l'intérêt général.\n\n" +
