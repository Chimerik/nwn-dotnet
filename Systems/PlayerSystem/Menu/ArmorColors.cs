      ...
      private void HandleItemColorsEvents(ModuleEvents.OnNuiEvent nuiEvent)
      {
        ...
        switch (nuiEvent.EventType)
        {
          case NuiEventType.Click:
            ...
            {
              nuiEvent.Player.NuiDestroy(nuiEvent.WindowToken);
              player.CreateArmorAppearanceWindow(player.oid.ControlledCreature.GetItemInSlot(InventorySlot.Chest));
              return;
            }
          ...
          case NuiEventType.Watch:
            ...
            if (nuiEvent.ElementId == "channelSelection" || nuiEvent.ElementId == "spotSelection")
            {
              ...
              {
                case -1:
                  currentColor = ((int)coloredItem.Appearance.GetArmorColor(channel)) + 1;
                  break;
                default:
                  currentColor = ((int)coloredItem.Appearance.GetArmorPieceColor((ItemAppearanceArmorModel)spot, channel)) + 1;
                  break;
              }
