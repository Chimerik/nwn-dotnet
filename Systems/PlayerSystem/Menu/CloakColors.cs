...
namespace NWN.Systems
{
  public partial class PlayerSystem
  {
    ...
    {
      public class CloakColorWindow : PlayerWindow
      {
        ...
        public CloakColorWindow(Player player, NwItem item) : base(player)
        {
        ...
        public void CreateWindow(NwItem item)
        {
          ...
          NuiRect windowRectangle = player.windowRectangles.ContainsKey(windowId) ? player.windowRectangles[windowId] : new NuiRect(player.oid.GetDeviceProperty(PlayerDeviceProperty.GuiWidth) * 0.01f, player.oid.GetDeviceProperty(PlayerDeviceProperty.GuiHeight) * 0.01f, player.oid.GetDeviceProperty(PlayerDeviceProperty.GuiWidth) / 4 + 50, player.oid.GetDeviceProperty(PlayerDeviceProperty.GuiHeight) / 2);
        ...
        private void HandleCloakColorsEvents(ModuleEvents.OnNuiEvent nuiEvent)
        {
          ...
          switch (nuiEvent.EventType)
          {
            case NuiEventType.Click:
              ...
              if (colorChanel == ItemAppearanceArmorColor.Metal1 || colorChanel == ItemAppearanceArmorColor.Metal2)
                channelSelected = "metal";
