...
namespace NWN.Systems
{
  public partial class PlayerSystem
  {
    private void HandlePlayerConnect(ModuleEvents.OnClientEnter HandlePlayerConnect)
    {
      ...
      player.oid.SetGuiPanelDisabled(GUIPanel.CharacterSheet, true);
    ...
    public partial class Player
    {
      ...
      public void FinalizePlayerData()
      {
        ...
        InitializeExpertiseDarmeChoice();
        InitializeOrdreDivinChoice();
