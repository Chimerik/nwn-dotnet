...
namespace NWN.Systems
{
  public static partial class NativeUtils
  {
    ...
    {
      if(!data.m_bRangedAttack.ToBool() && target.m_nCurrentAction == (ushort)Action.AttackObject 
        && target.m_ScriptVars.GetInt(CreatureUtils.ManoeuvreTypeVariableExo) == CustomSkill.WarMasterRiposte
