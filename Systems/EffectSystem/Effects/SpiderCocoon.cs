...
namespace NWN.Systems
{
  public partial class EffectSystem
  {
    ...
    public static Effect SpiderCocoon
    {
      get
      {
        Effect eff = Effect.LinkEffects(Effect.Paralyze(), Effect.VisualEffect(VfxType.DurWeb), Effect.RunAction(onIntervalHandle: onIntervalSpiderCocoonCallback, interval: NwTimeSpan.FromRounds(1)));
