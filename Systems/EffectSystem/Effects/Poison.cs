...
namespace NWN.Systems
{
  public partial class EffectSystem
  {
    ...
    public static SavingThrowResult ApplyPoison(NwCreature target, NwCreature caster, TimeSpan duration, Ability SaveAbility, Ability DCAbility = Ability.Dexterity, bool repeatSave = false)
    {
