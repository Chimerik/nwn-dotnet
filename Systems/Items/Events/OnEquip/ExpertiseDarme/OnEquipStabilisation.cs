...
namespace NWN.Systems
{
  ...
  {
    public static void OnEquipStabilisation(OnItemEquip onEquip)
    {
      ...
      if (Utils.In(oItem.BaseItem.ItemType, BaseItemType.HeavyCrossbow, BaseItemType.Longbow, BaseItemType.ThrowingAxe))
      {
