...
namespace NWN.Systems
{
  public static partial class SpellUtils
  {
    ...
    public static readonly Dictionary<int, ItemProperty[]> enchantementCategories = new()
    {
      ...
      //NIVEAU 4
      {860, new ItemProperty[] { ItemProperty.ACBonusVsRace(RacialType.Halfling, 4), ItemProperty.ACBonusVsRace(RacialType.Human, 4), ItemProperty.ACBonusVsRace(RacialType.HalfElf, 4), ItemProperty.ACBonusVsRace(RacialType.HalfOrc, 4), ItemProperty.ACBonusVsRace(RacialType.Elf, 4), ItemProperty.ACBonusVsRace(RacialType.Gnome, 4), ItemProperty.ACBonusVsRace(RacialType.Dwarf, 4), ItemProperty.ACBonusVsRace(RacialType.MagicalBeast, 4), ItemProperty.ACBonusVsRace(RacialType.Dragon, 4), ItemProperty.ACBonusVsRace(RacialType.Aberration, 4), ItemProperty.AttackBonusVsRace(RacialType.Halfling, 4), ItemProperty.AttackBonusVsRace(RacialType.Human, 4), ItemProperty.AttackBonusVsRace(RacialType.HalfElf, 4), ItemProperty.AttackBonusVsRace(RacialType.HalfOrc, 4), ItemProperty.AttackBonusVsRace(RacialType.Elf, 4), ItemProperty.AttackBonusVsRace(RacialType.Gnome, 4), ItemProperty.AttackBonusVsRace(RacialType.Dwarf, 4), ItemProperty.AttackBonusVsRace(RacialType.MagicalBeast, 4), ItemProperty.AttackBonusVsRace(RacialType.Dragon, 4), ItemProperty.AttackBonusVsRace(CustomRacialType.Fielon, 4), ItemProperty.AttackBonusVsRace(CustomRacialType.Celeste, 4), ItemProperty.AttackBonusVsRace(RacialType.Aberration, 4) } },
      ...
      //NIVEAU 7
      {869, new ItemProperty[] { ItemProperty.EnhancementBonusVsRace(RacialType.Halfling, 4), ItemProperty.EnhancementBonusVsRace(RacialType.Human, 4), ItemProperty.EnhancementBonusVsRace(RacialType.HalfElf, 4), ItemProperty.EnhancementBonusVsRace(RacialType.HalfOrc, 4), ItemProperty.EnhancementBonusVsRace(RacialType.Elf, 4), ItemProperty.EnhancementBonusVsRace(RacialType.Gnome, 4), ItemProperty.EnhancementBonusVsRace(RacialType.Dwarf, 4), ItemProperty.EnhancementBonusVsRace(RacialType.MagicalBeast, 4), ItemProperty.EnhancementBonusVsRace(RacialType.Dragon, 4), ItemProperty.EnhancementBonusVsRace(CustomRacialType.Fielon, 4), ItemProperty.EnhancementBonusVsRace(CustomRacialType.Celeste, 4), ItemProperty.EnhancementBonusVsRace(RacialType.Aberration, 4) } },
