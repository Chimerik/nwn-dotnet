...
namespace NWN.Systems
{
  public partial class PlayerSystem
  {
    ...
    {
      public class RangerKnacksSelectionWindow : PlayerWindow
      {
        ...
        public RangerKnacksSelectionWindow(Player player, int nbTechs) : base(player)
        {
          windowId = "rangerKnacksSelection";
        ...
        public async void CreateWindow(int nbTechs)
        {
          ...
          window = new NuiWindow(rootColumn, $"Choix de {nbTechs} truc(s) de rôdeur")
          {
            Geometry = geometry,
            Resizable = false,
            Collapsed = false,
          ...
          if (player.oid.TryCreateNuiWindow(window, out NuiWindowToken tempToken, windowId))
          {
            ...
            player.oid.LoginCreature.GetObjectVariable<PersistentVariableInt>("_IN_RANGER_KNACKS_SELECTION").Value = nbTechs;            
          }
          else
              ...
              switch (nuiEvent.ElementId)
              {
                ...
                case "validate":
                  ...
                  foreach (var tech in acquiredTechs)
                  {
                    ...
                    player.oid.SendServerMessage($"Vous apprenez le truc de Rôdeur {StringUtils.ToWhitecolor(tech.name)}", ColorConstants.Orange);
                  }

                  player.oid.LoginCreature.GetObjectVariable<PersistentVariableInt>("_IN_RANGER_KNACKS_SELECTION").Delete();
