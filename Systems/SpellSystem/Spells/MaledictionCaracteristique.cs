  ...
  public partial class SpellSystem
  {
    public static List<NwGameObject> MaledictionCaracteristique(NwGameObject oCaster, NwSpell spell, SpellEntry spellEntry, NwGameObject oTarget, NwClass casterClass, int spellId)
    {
      ...
      if (saveFailed)
      {
        ...
        NWScript.AssignCommand(oCaster, () => target.ApplyEffect(EffectDuration.Temporary, EffectSystem.GetMaledictionCaracteristique(spellId), NwTimeSpan.FromRounds(spellEntry.duration)));
      }
