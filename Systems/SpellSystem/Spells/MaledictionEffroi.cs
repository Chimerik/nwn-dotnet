  ...
  public partial class SpellSystem
  {
    public static List<NwGameObject> MaledictionEffroi(NwGameObject oCaster, NwSpell spell, SpellEntry spellEntry, NwGameObject oTarget, NwClass casterClass)
    {
      ...
      if (saveFailed)
      {
        ...
        NWScript.AssignCommand(oCaster, () => target.ApplyEffect(EffectDuration.Temporary, EffectSystem.GetMaledictionEffroi(casterClass.SpellCastingAbility), NwTimeSpan.FromRounds(spellEntry.duration)));
      }
