      ...
      if (oCaster is not NwCreature caster)
      {
        ...
        foreach (var target in targets)
          if (target is NwCreature targetCreature
            && CreatureUtils.GetSavingThrowResult(targetCreature, spellEntry.savingThrowAbility, oCaster, spellDC, spellEntry, SpellConfig.SpellEffectType.Fear) == SavingThrowResult.Failure)
        {
