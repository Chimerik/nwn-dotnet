  ...
  public partial class SpellSystem
  {
    public static List<NwGameObject> MaledictionAttaque(NwGameObject oCaster, NwSpell spell, SpellEntry spellEntry, NwGameObject oTarget, NwClass casterClass)
    {
      ...
      if (CreatureUtils.GetSavingThrow(oCaster, target, spellEntry.savingThrowAbility, spellDC, spellEntry) == SavingThrowResult.Failure)
      {
        ...
        NWScript.AssignCommand(oCaster, () => target.ApplyEffect(EffectDuration.Temporary, EffectSystem.MaledictionAttaque, SpellUtils.GetSpellDuration(oCaster, spellEntry)));
      }
