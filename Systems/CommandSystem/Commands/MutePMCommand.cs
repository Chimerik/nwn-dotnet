...
namespace NWN.Systems
{
  public static partial class CommandSystem
  {
    private static void ExecuteMutePMCommand(ChatSystem.Context ctx, Options.Result options)
    {
      ...
      {
        if (NWNX.Object.GetInt(ctx.oSender, "__BLOCK_" + ctx.oTarget.Name + "_MP") == 0)
        {
          NWNX.Object.SetInt(ctx.oSender, "__BLOCK_" + ctx.oTarget.Name + "_MP", 1, true);
        ...
        {
          NWNX.Object.DeleteInt(ctx.oSender, "__BLOCK_" + ctx.oTarget.Name + "_MP");
          NWScript.SendMessageToPC(ctx.oSender, "Vous ne bloquez plus les mps de " + ctx.oTarget.Name);
        }
      }
      else
      {
        if (NWNX.Object.GetInt(ctx.oSender, "__BLOCK_ALL_MP") == 0)
        {
          NWNX.Object.SetInt(ctx.oSender, "__BLOCK_ALL_MP", 1, true);
        ...
        {
          NWNX.Object.DeleteInt(ctx.oSender, "__BLOCK_ALL_MP");
