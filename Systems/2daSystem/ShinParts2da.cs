...
{
  public class ShinPartsTable : ITwoDimArray
  {
    private readonly Dictionary<int, Entry> entries = new Dictionary<int, Entry>();

    public List<NuiComboEntry> GetValidShinAppearancesForGender(Gender gender)
    {
  ...
  {
    public static ShinPartsTable shinPartsTable;
    public ShinParts2da(TwoDimArrayFactory twoDimArrayFactory)
    {
      shinPartsTable = twoDimArrayFactory.Get2DA<ShinPartsTable>("parts_shin");
    }
  }
}
