...
{
  public class ForearmPartsTable : ITwoDimArray
  {
    private readonly Dictionary<int, Entry> entries = new Dictionary<int, Entry>();

    public List<NuiComboEntry> GetValidForearmAppearancesForGender(Gender gender)
    {
  ...
  {
    public static ForearmPartsTable forearmPartsTable;
    public ForearmParts2da(TwoDimArrayFactory twoDimArrayFactory)
    {
      forearmPartsTable = twoDimArrayFactory.Get2DA<ForearmPartsTable>("parts_forearm");
    }
  }
}
