...
namespace NWN.Systems
{
  class Language
  {
    ...
    {
      if (player.ControlledCreature.GetLocalVariable<int>("_ACTIVE_LANGUAGE").Value == feat)
      {
        player.ControlledCreature.GetLocalVariable<int>("_ACTIVE_LANGUAGE").Value = (int)CustomFeats.Invalid;
      ...
      {
        player.ControlledCreature.GetLocalVariable<int>("_ACTIVE_LANGUAGE").Value = feat;
